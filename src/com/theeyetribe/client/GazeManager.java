...
public class GazeManager implements IGazeApiResponseListener, IGazeApiConnectionListener
{
    ...
    //Khusus untuk pertukaran data perubahan hasil kalibrasi
    public CalibrationResult hasilKalibrasi, cekHasilKalibrasiTerbaruPadaICRL;
                        ...
                        else if (reply.category.compareTo(Protocol.CATEGORY_CALIBRATION) == 0)
                        {
                            ...
                            else if (reply.request.compareTo(Protocol.CALIBRATION_REQUEST_POINTEND) == 0)
                            {
                                ...
                                {                               	                                                                                          
                                	...
                                	cekHasilKalibrasiTerbaruPadaICRL = lastCalibrationResult;
                                                ...
                                                threadPool.execute(new Runnable()
                                                {
                                                    ...
                                                    public void run()
                                                    {
                                                        ...
                                                        {	//Asli
                                                        	...
                                                        	System.out.println("ICRL Kedua");
                                                        	
                                                        	//System.out.println("Gaze Manager Data: "+hasilKalibrasi.averageErrorDegree);
                                                        	System.out.println("Cek Hasil Kalibrasi Terakhir:"+cekHasilKalibrasiTerbaruPadaICRL.averageErrorDegree);
    ...
    //Ganti Hasil Kalibrasi
    public void showGantiHasilKalibrasi(CalibrationResult calibrationResult){
    	hasilKalibrasi = calibrationResult;
    	/*
        synchronized (calibrationResultListeners){
            for (final ICalibrationResultListener listener : calibrationResultListeners){
                try{
                    threadPool.execute(new Runnable(){
                        public void run(){
                            try{
                            	...
                            	//Dimodif
                            	listener.onCalibrationChanged(true,
                                        hasilKalibrasi);
